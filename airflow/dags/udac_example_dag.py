...
run_staging_quality_checks = DataQualityOperator(
    ...
    dag=dag,
    redshift_conn_id='redshift',
    # specify minumum expected values in each table here
    # set to 1 for development
    tables={"staging_events":1, 
            "staging_songs": 1}, 
)
...
load_user_dimension_table >> run_transformation_quality_checks
load_artist_dimension_table >> run_transformation_quality_checks
load_song_dimension_table >> run_transformation_quality_checks
load_time_dimension_table >> run_transformation_quality_checks
